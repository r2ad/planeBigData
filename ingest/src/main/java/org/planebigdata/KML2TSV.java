...
public class KML2TSV extends DefaultHandler {
    ...
    */
    ...
    final public Coordinates getCoordinates(int idx) {
    ...
    @Override
    final public void endElement(String uri, String lName, String qName) throws SAXException {
    ...
    final public void parseCoordinates(String content) throws SAXException {
    ...
    final private String extractDepartTime(String content) throws SAXException {
    ...
    final public void extractCoordinates(String longLat) throws SAXException {
